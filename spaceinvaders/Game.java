...
public class Game extends Canvas {
        ...
        private boolean upPressed = false; // true if right arrow key currently pressed
        ...
        private double moveSpeed = 300; // hor. vel. of ship (px/s)(600)
        private long lastFire = 0; // time last shot fired
        private long firingInterval = 300; // interval between shots (ms)(500)
    	...
    	public Game() {
    		...
    		JFrame container = new JFrame("Antony 64 Space Invaders");
    	...
    	private void initEntities() {
              // create the ship and put in center of screen (370, 550)
	...
	public void gameLoop() {
          ...
          while (gameRunning) {
           ...
           if (waitingForKeyPress) {
            ...
            // if space bar pressed, try to fire
            if (firePressed) {
              tryToFire();
            } // if
